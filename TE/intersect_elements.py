...
Human_bed = read_bed('/media/vikas/thiccy1/data/TEBAG/local_data/TE/ucsc.rmsk.salmon.bed')
Human_Chimp_lifted_bed = read_bed('/media/vikas/thiccy1/data/TEBAG/local_data/TE/Human.Chimp.check.lifted.bed')
Human_Gorilla_lifted_bed = read_bed('/media/vikas/thiccy1/data/TEBAG/local_data/TE/Human.Gorilla.check.lifted.bed')
Human_Orangutan_lifted_bed = read_bed('/media/vikas/thiccy1/data/TEBAG/local_data/TE/Human.Orangutan.check.lifted.bed')
Human_Bonobo_lifted_bed = read_bed('/media/vikas/thiccy1/data/TEBAG/local_data/TE/Human.Bonobo.check.lifted.bed')
